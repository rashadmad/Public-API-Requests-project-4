    ...
    .then(userData => {
      ...
      cards.forEach(card => {
        ...
        card.addEventListener("click", () => {
          ...
          createModal(results[idOfButtonPressed].name.first + " " + results[idOfButtonPressed].name.last, results[idOfButtonPressed].picture.thumbnail, results[idOfButtonPressed].location.city, results[idOfButtonPressed].cell, results[idOfButtonPressed].location.street + results[idOfButtonPressed].location.city + " ," + results[idOfButtonPressed].location.postcode, results[idOfButtonPressed].dob.date)
        })
      })
